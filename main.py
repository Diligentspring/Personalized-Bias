...
parser.add_argument("--max_train_iteration", type=int, default=1000,
...
def train(exp_settings):
    ...
    train_set = ultra.utils.read_data(args.data_dir, args.train_data_prefix, args.click_model_dir, args.max_list_cutoff, args.train_dataset)
...
def test(exp_settings):
    ...
    model = NavieAlgorithm_softmax(test_set, exp_settings)
