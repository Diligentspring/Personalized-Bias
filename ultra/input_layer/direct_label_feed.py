...
class DirectLabelFeed(BaseInputFeed):
    ...
    def prepare_true_labels_with_index_ULTRA(
            self, data_set, index, docid_inputs, letor_features, labels, check_validation=True, qids=None):
        i = index
        # Generate label list.
        # label_list = [
