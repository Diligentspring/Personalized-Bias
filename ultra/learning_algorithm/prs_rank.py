...
class PRSrank_modify(BaseAlgorithm):
    ...
    def __init__(self, data_set, exp_settings):
        ...
        # self.exams = [1, 0.37261113, 0.23703891, 0.18156132, 0.15188947, 0.13348942, 0.12096038, 0.11186295, 0.10494149, 0.09948595] #IPS_average_oracle_u10
        # self.exams = [1, 0.41660027, 0.29407931, 0.2438562,  0.21679345, 0.19988651, 0.18830644, 0.17986379, 0.17342505, 0.16834508]  # IPS_average_oracle_u5
        # self.exams = [1, 0.2771141, 0.14324974, 0.09423585, 0.07020406, 0.0563208, 0.04741161, 0.04126179, 0.03678364, 0.0333871]  # IPS_average_oracle_u20
        self.exams = [1.0000, 0.3682, 0.2220, 0.1719, 0.1433, 0.1209, 0.1097, 0.1017, 0.0914, 0.0958] #IPS_average_regressionEM_u10
